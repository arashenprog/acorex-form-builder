...
import { AXF_NAME_PROPERTY, AXF_TEXT_PROPERTY, AXF_CLICK_EVENT, AXF_INIT_EVENT, AXF_VISIBLE_PROPERTY, AXF_DISPLAY_NAME_PROPERTY, AXF_FONT_PROPERTY } from '../../config/general-properties';
