...
import { AXF_ITEM_DATASOURCE_PROPERTY, AXF_DS_LIST_PROPERTY, AXF_NAME_PROPERTY, AXF_VALUE_CHANGE_EVENT, AXF_TAG_PROPERTY, AXF_VALIDATION_PROPERTY, AXF_DISPLAY_NAME_PROPERTY, AXF_VISIBLE_PROPERTY, AXF_DATA_TYPE_PROPERTY } from '../../config/general-properties';
