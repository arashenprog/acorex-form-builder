...
import {  AXF_BG_COLOR_PROPERTY, AXF_VISIBLE_PROPERTY, AXF_BOX_STYLE_PROPERTY, AXF_TABLE_LAYOUT_PROPERTY, AXF_MINWIDTH_PROPERTY, AXF_NAME_PROPERTY } from '../../config/general-properties';
