...
import { AXF_NAME_PROPERTY, AXF_VISIBLE_PROPERTY, AXF_TAG_PROPERTY, AXF_VALIDATION_PROPERTY, AXF_VALUE_CHANGE_EVENT, AXF_INIT_EVENT, AXF_DISPLAY_NAME_PROPERTY, AXF_DATA_TYPE_PROPERTY, AXF_SET_CURRENT_TIME_PROPERTY } from '../../config/general-properties';
