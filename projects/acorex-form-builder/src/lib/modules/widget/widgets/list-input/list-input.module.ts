...
import { AXF_NAME_PROPERTY, AXF_BOX_STYLE_PROPERTY, AXF_VALUE_CHANGE_EVENT, AXF_INIT_EVENT, AXF_ITEM_DATASOURCE_PROPERTY, AXF_VISIBLE_PROPERTY, AXF_TAG_PROPERTY, AXF_DISPLAY_NAME_PROPERTY, AXF_DATA_TYPE_PROPERTY, AXF_VALIDATION_PROPERTY } from '../../config/general-properties';
